...
#
# Generated by export_simulation on Tue Oct 26 15:05:19 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './xadc_fpro.sh' script.

./xadc_fpro.sh -reset_run
...
./xadc_fpro.sh -noclean_files

For more information on the script, please type './xadc_fpro.sh -help'.
